...
export class AuthPerfilTiendaGuard implements CanActivate {
  ...
  canActivate(): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree {
    ...
    var authPerfilSinConectarmealServidor: Boolean = this.authService.AuthPerfilSinConectarmealServidor_("2");
    ...
    {
      this.constantes.DesplegarMensajePermantendeError("Sin Acceso","Debes loguearte como tienda para poder acceder");
