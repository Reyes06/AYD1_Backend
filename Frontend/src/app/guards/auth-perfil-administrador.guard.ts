...
export class AuthPerfilAdministradorGuard implements CanActivate {
  ...
  canActivate(): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree {
    ...
    var authPerfilSinConectarmealServidor: Boolean = this.authService.AuthPerfilSinConectarmealServidor_("1");
    ...
    {
      this.constantes.DesplegarMensajePermantendeError("Sin Acceso","Debes loguearte como administrador para poder acceder");
